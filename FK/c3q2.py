...
#print (np.around(mr.MassMatrix(thetalist, Mlist, Glist, Slist), decimals=2))
#print (np.around(mr.VelQuadraticForces(thetalist, dthetalist, Mlist, Glist, Slist), decimals=2))
#print (np.around(mr.GravityForces(thetalist, g, Mlist, Glist, Slist), decimals=2))
#print (np.around(mr.EndEffectorForces(thetalist, Ftip, Mlist, Glist, Slist), decimals=2))
print (np.around(mr.ForwardDynamics(thetalist, dthetalist, taulist, g, Ftip, Mlist, Glist, Slist), decimals=2))