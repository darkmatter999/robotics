...
#***LOADING THE PREVIOUSLY SAVED HORSE OR HUMAN DATASET WITH KERAS AND INFER, SUBSEQUENTLY CONVERT MODEL INTO .tflite***
...
converter = tf.lite.TFLiteConverter.from_saved_model("saved_horse_human3") 
