...
#***LOADING THE PREVIOUSLY SAVED MASK DETECTION DATASET WITH KERAS AND INFER, SUBSEQUENTLY CONVERT MODEL INTO .tflite AND SAVE .tflite MODEL***
...
converter = tf.lite.TFLiteConverter.from_saved_model("saved_mask_detect_tiny") 
...
with open('mask_tiny.tflite', 'wb') as f:
